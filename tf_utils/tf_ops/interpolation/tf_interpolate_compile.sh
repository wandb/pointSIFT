...
# TF1.4
g++ -std=c++11 tf_interpolate.cpp -o tf_interpolate_so.so -shared -fPIC -I$TENSORFLOW_INCLUDE_PATH -I $CUDA_INCLUDE -lcudart -L $CUDA_LIB64 -O2 -D_GLIBCXX_USE_CXX11_ABI=0
