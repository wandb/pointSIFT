...
# TF1.4
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I $TENSORFLOW_INCLUDE_PATH -I $CUDA_INCLUDE_PATH -I $TENSORFLOW_NSYNC_PUBLIC_PATH -lcudart -L $CUDA_LIB64_PATH -L$TENSORFLOW_PATH
